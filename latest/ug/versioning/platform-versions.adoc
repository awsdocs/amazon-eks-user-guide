...
| `1.29.15`
| `eks.66`
| New platform version with security fixes and enhancements. 1.29 `eks.64` and 1.29 `eks.65` were discarded internally and never released.
| March 18, 2026
...
| `1.29.15`
| `eks.60`
| New platform version with security fixes and enhancements. 1.29 `eks.59` was discarded internally and never released.
| January 16, 2026
