...
This section is designed to give you a comprehensive overview of how Kubernetes versioning operates within Amazon Elastic Kubernetes Service (EKS). You'll find details on supported versions, the lifecycle and deprecation policies, upgrade processes, and key considerations for managing your cluster verions. 
