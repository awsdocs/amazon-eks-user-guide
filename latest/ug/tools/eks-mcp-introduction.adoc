...
* *Integrated {aws} console experience.* The hosted service powers the Amazon Q Developer chat experience directly in the EKS console, enabling natural language troubleshooting and cluster management without leaving your browser.
