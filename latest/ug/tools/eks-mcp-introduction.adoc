...
* *Eliminate installation and maintenance.* With the EKS MCP server being hosted in the {aws} cloud, you no longer need to manage version updates, or troubleshoot local server issues. Simply configure your AI assistant to connect to the hosted EKS MCP server endpoint, and you're ready to start working with your EKS clusters.
...
Deploy applications, manage Kubernetes resources, and inspect cluster state.
...
include::eks-mcp-tools.adoc[leveloffset=+1]
