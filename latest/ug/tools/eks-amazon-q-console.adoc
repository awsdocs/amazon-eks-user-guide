...
image::images/eks-mcp-amazon-q-console-inspect-issue.png[Inspect issue,scaledwidth=100%]

image::images/eks-mcp-amazon-q-console-inspect-view.png[View issue,scaledwidth=100%]
