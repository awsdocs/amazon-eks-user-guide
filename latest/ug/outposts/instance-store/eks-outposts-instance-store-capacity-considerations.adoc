...
[.topic]
[#eks-outposts-instance-store-capacity-considerations]
...
[#eks-outposts-instance-store-capacity-considerations-architecture]
...
[#eks-outposts-instance-store-capacity-considerations-instance-type]
...
[#eks-outposts-instance-store-capacity-considerations-placement]
...
[#eks-outposts-instance-store-capacity-considerations-spread-levels]
=== Spread levels
...
[#eks-outposts-instance-store-capacity-considerations-capacity-planning]
== Capacity planning
...
[#eks-outposts-instance-store-capacity-considerations-troubleshooting]
...
For more information about troubleshooting local clusters, see <<eks-outposts-instance-store-troubleshooting>>.
