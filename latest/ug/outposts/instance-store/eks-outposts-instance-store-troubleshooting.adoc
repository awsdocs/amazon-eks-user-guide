...
[.topic]
[#eks-outposts-instance-store-troubleshooting]
...
[#eks-outposts-instance-store-troubleshooting-kubectl]
...
[#eks-outposts-instance-store-troubleshooting-nodes-not-joining]
...
[#eks-outposts-instance-store-troubleshooting-creating]
...
* *Subnet issues:* Verify that the subnets you specified are in the Availability Zone to which the Outpost is homed, and that each subnet has at least 3 available IP addresses. See <<eks-outposts-instance-store-vpc-subnet-requirements>>.
====

[#eks-outposts-instance-store-troubleshooting-updating]
...
[#eks-outposts-instance-store-troubleshooting-etcd-quorum]
.`etcd` quorum loss
[%collapsible]
====
...
Contact link:support/home[{aws} Support Center,type="console"].
====
