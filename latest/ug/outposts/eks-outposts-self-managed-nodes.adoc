...
. For *Specify template*, select *Upload a template file* and then select *Choose file*. Select the `amazon-eks-outpost-nodegroup.yaml` file that you downloaded in a previous step and then select *Next*.
