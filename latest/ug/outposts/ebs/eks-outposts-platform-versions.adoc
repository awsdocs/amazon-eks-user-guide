...
[#outposts-platform-versions-1-32]
...
|Initial release of Kubernetes version `v1.32` for local Amazon EKS clusters on Outposts. kube-proxy `v1.32.12`. {aws} IAM Authenticator `v0.7.10`. Amazon VPC CNI plugin for Kubernetes `v1.20.4`. CoreDNS `v1.11.4`. {aws} Cloud Controller Manager `v1.32.5`. Bottlerocket version `v1.57.0`.
|April 10, 2026
|===
