...
[abstract]
--
Learn how to prepare your Amazon EKS local cluster on {aws} Outposts for network disconnects, including x.509 certificate authentication, pod failover tuning, monitoring, scaling, and storage options.
--
...
[#outposts-network-disconnects-pod-failover]
== Tune Kubernetes pod failover behavior

[abstract]
--
Learn how to tune pod failover behavior during network disconnects to prevent unnecessary pod evictions on {aws} Outposts.
--
