...
* https://github.com/aws-samples/aws-eks-se-samples/tree/main/examples/eksctl/how-to-ubuntu-nodegroups[Add an Ubuntu Managed Node Group to a cluster]
