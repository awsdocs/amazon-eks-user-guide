...
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.33.4/2025-08-20/bin/darwin/amd64/kubectl
----
**** Kubernetes `1.32`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.32.8/2025-08-20/bin/darwin/amd64/kubectl
----
**** Kubernetes `1.31`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.31.12/2025-08-20/bin/darwin/amd64/kubectl
----
**** Kubernetes `1.30`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.30.14/2025-08-20/bin/darwin/amd64/kubectl
----
**** Kubernetes `1.29`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.29.15/2025-08-20/bin/darwin/amd64/kubectl
----
**** Kubernetes `1.28`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.28.15/2025-08-20/bin/darwin/amd64/kubectl
----
**** Kubernetes `1.27`
+
[source,bash,subs="verbatim,attributes"]
...
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.33.4/2025-08-20/bin/darwin/amd64/kubectl.sha256
----
***** Kubernetes `1.32`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.32.8/2025-08-20/bin/darwin/amd64/kubectl.sha256
----
***** Kubernetes `1.31`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.31.12/2025-08-20/bin/darwin/amd64/kubectl.sha256
----
***** Kubernetes `1.30`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.30.14/2025-08-20/bin/darwin/amd64/kubectl.sha256
----
***** Kubernetes `1.29`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.29.15/2025-08-20/bin/darwin/amd64/kubectl.sha256
----
***** Kubernetes `1.28`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.28.15/2025-08-20/bin/darwin/amd64/kubectl.sha256
----
***** Kubernetes `1.27`
+
[source,bash,subs="verbatim,attributes"]
...
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.32.8/2025-08-20/bin/linux/amd64/kubectl
----
**** Kubernetes `1.31`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.31.12/2025-08-20/bin/linux/amd64/kubectl
----
**** Kubernetes `1.30`
+
[source,bash,subs="verbatim,attributes"]
...
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.29.15/2025-08-20/bin/linux/amd64/kubectl
----
**** Kubernetes `1.28`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.28.15/2025-08-20/bin/linux/amd64/kubectl
----
**** Kubernetes `1.27`
+
[source,bash,subs="verbatim,attributes"]
...
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.33.4/2025-08-20/bin/linux/amd64/kubectl.sha256
----
***** Kubernetes `1.32`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.32.8/2025-08-20/bin/linux/amd64/kubectl.sha256
----
***** Kubernetes `1.31`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.31.12/2025-08-20/bin/linux/amd64/kubectl.sha256
----
***** Kubernetes `1.30`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.30.14/2025-08-20/bin/linux/amd64/kubectl.sha256
----
***** Kubernetes `1.29`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.29.15/2025-08-20/bin/linux/amd64/kubectl.sha256
----
***** Kubernetes `1.28`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.28.15/2025-08-20/bin/linux/amd64/kubectl.sha256
----
***** Kubernetes `1.27`
+
[source,bash,subs="verbatim,attributes"]
...
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.32.8/2025-08-20/bin/linux/arm64/kubectl
----
**** Kubernetes `1.31`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.31.12/2025-08-20/bin/linux/arm64/kubectl
----
**** Kubernetes `1.30`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.30.14/2025-08-20/bin/linux/arm64/kubectl
----
**** Kubernetes `1.29`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.29.15/2025-08-20/bin/linux/arm64/kubectl
----
**** Kubernetes `1.28`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.28.15/2025-08-20/bin/linux/arm64/kubectl
----
**** Kubernetes `1.27`
+
[source,bash,subs="verbatim,attributes"]
...
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.33.4/2025-08-20/bin/linux/arm64/kubectl.sha256
----
***** Kubernetes `1.32`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.32.8/2025-08-20/bin/linux/arm64/kubectl.sha256
----
***** Kubernetes `1.31`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.31.12/2025-08-20/bin/linux/arm64/kubectl.sha256
----
***** Kubernetes `1.30`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.30.14/2025-08-20/bin/linux/arm64/kubectl.sha256
----
***** Kubernetes `1.29`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.29.15/2025-08-20/bin/linux/arm64/kubectl.sha256
----
***** Kubernetes `1.28`
+
[source,bash,subs="verbatim,attributes"]
----
curl -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.28.15/2025-08-20/bin/linux/arm64/kubectl.sha256
----
***** Kubernetes `1.27`
+
[source,bash,subs="verbatim,attributes"]
...
[source,bash,subs="verbatim,attributes"]
----
curl.exe -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.33.4/2025-08-20/bin/windows/amd64/kubectl.exe
----
**** Kubernetes `1.32`
+
[source,bash,subs="verbatim,attributes"]
----
curl.exe -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.32.8/2025-08-20/bin/windows/amd64/kubectl.exe
----
**** Kubernetes `1.31`
+
[source,bash,subs="verbatim,attributes"]
----
curl.exe -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.31.12/2025-08-20/bin/windows/amd64/kubectl.exe
----
**** Kubernetes `1.30`
+
[source,bash,subs="verbatim,attributes"]
----
curl.exe -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.30.14/2025-08-20/bin/windows/amd64/kubectl.exe
----
**** Kubernetes `1.29`
+
[source,bash,subs="verbatim,attributes"]
----
curl.exe -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.29.15/2025-08-20/bin/windows/amd64/kubectl.exe
----
**** Kubernetes `1.28`
+
[source,bash,subs="verbatim,attributes"]
----
curl.exe -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.28.15/2025-08-20/bin/windows/amd64/kubectl.exe
----
**** Kubernetes `1.27`
+
[source,bash,subs="verbatim,attributes"]
...
[source,bash,subs="verbatim,attributes"]
----
curl.exe -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.33.4/2025-08-20/bin/windows/amd64/kubectl.exe.sha256
----
***** Kubernetes `1.32`
+
[source,bash,subs="verbatim,attributes"]
----
curl.exe -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.32.8/2025-08-20/bin/windows/amd64/kubectl.exe.sha256
----
***** Kubernetes `1.31`
+
[source,bash,subs="verbatim,attributes"]
----
curl.exe -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.31.12/2025-08-20/bin/windows/amd64/kubectl.exe.sha256
----
***** Kubernetes `1.30`
+
[source,bash,subs="verbatim,attributes"]
----
curl.exe -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.30.14/2025-08-20/bin/windows/amd64/kubectl.exe.sha256
----
***** Kubernetes `1.29`
+
[source,bash,subs="verbatim,attributes"]
----
curl.exe -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.29.15/2025-08-20/bin/windows/amd64/kubectl.exe.sha256
----
***** Kubernetes `1.28`
+
[source,bash,subs="verbatim,attributes"]
----
curl.exe -O https://s3.us-west-2.amazonaws.com/amazon-eks/1.28.15/2025-08-20/bin/windows/amd64/kubectl.exe.sha256
----
***** Kubernetes `1.27`
+
[source,bash,subs="verbatim,attributes"]
