...
[.topic]
[#ml-inference]
= Running AI/ML inference workloads on Amazon EKS
...
The walkthrough uses the cluster infrastructure from the <<ml-cluster-setup,Cluster setup>> section and works with both EKS Auto Mode and self-managed Karpenter paths.
