...
----
+
For advanced configuration options, see the link:https://github.com/NVIDIA/k8s-dra-driver-gpu/blob/main/deployments/helm/nvidia-dra-driver-gpu/values.yaml[NVIDIA DRA driver Helm chart].
+
