...
For step-by-step instructions using the {aws} CLI, see <<ml-cluster-setup-cli>>. For step-by-step instructions using Terraform, see <<ml-cluster-setup-tf>>.

include::ml-cluster-setup-cli.adoc[leveloffset=+1]

include::ml-cluster-setup-tf.adoc[leveloffset=+1]
