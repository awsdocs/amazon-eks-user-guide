...
== Maximize NVIDIA CPU performance for ML on EKS
...
* https://aws.amazon.com/blogs/containers/announcing-nvidia-gpu-support-for-bottlerocket-on-amazon-ecs/[Announcing NVIDIA GPU support for Bottlerocket on Amazon ECS]
