[.topic]
= EKS Auto Mode API Reference WIP
...
:lb-cap-desc: If the load balancing capability is enabled, EKS Auto Mode will create and delete Elastic Load Balancers in your {aws} account.
