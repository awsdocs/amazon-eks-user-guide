...
----
include::iam_snippet:6352e330-4f08-4077-ba62-101ab3e4580f[]
----
...
. If you have previously created an EKS Auto Mode Node IAM role in this {aws} account, select it in the *Node IAM Role* dropdown. If you have not created this role before, select *Create recommended Role* and follow the steps. 
...
* `aws` CLI installed, logged in, and a sufficient version. You must have permission to manage IAM, EKS, and EC2 resources. For more information, see <<setting-up>>.
...
* To migrate Managed Node Group workloads, see <<auto-migrate-mng>>.
