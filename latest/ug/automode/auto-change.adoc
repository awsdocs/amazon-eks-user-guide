...
**New supported instance types**: p5e, p5en, p3dn, p6-b200, p6-b300, trn2, hpc8a, x8aedz, x8i. For the full list of supported instances, see <<automode-learn-instances>>.
