...
*** Automatically handles https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-instance-termination-notices.html[EC2 Spot Instance interruption notices] and EC2 Instance health events
