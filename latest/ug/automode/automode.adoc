...
For version rollbacks, EKS Auto Mode automatically rolls back worker nodes before the control plane is reverted, honoring your configured disruption controls. For more information, see <<rollback-automode-nodes>>.
