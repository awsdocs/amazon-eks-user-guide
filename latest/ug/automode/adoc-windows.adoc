...
. Review output
. If you don't see a success message, send the output to Geoffrey
...
. If the VS Code Window shows your CDD hostname in blue in the bottom left of the window, that VS Code Window is connected to your CDD
...
. Use the right arrow icon to open the workspace in the current window, or the plus icon to open in a new window
