...
If you want to tag {aws} resources, you must attach additional policies to the Cluster IAM Role with sufficient permissions to modify tags on {aws} resources. 
