...
The following {aws} KMS keys can be used for Amazon EBS encryption when EKS Auto Mode launches instances:
    ...
    "Statement": [
        {
            ...
            "Principal": {
                "AWS": [
                    ...
                    "arn:aws:iam::<AWS_ACCOUNT_ID>:role/ClusterServiceRole"
                ]
            },
            "Action": [
                "kms:Encrypt",
...
* The `Admin` role typically needs these permissions for management operations
...
spec:
  ...
  ephemeralStorage:
    ...
    kmsKeyID: "arn:aws:kms:<REGION>:<AWS_ACCOUNT_ID>:key/<KEY-ID>"
----
...
* Key Alias ARN: `arn:aws:kms:us-wes-2:111122223333:alias/eks-auto-mode-key`
