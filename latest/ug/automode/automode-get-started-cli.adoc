...
* <<security-iam-awsmanpol-AmazonEKSBlockStoragePolicyV2,AmazonEKSBlockStoragePolicyV2>>
...
----
include::iam_snippet:3c455c2f-72a7-48be-b85c-d2431fccbb3b[]
----
...
[source,json,subs="verbatim,attributes"]
----
include::iam_snippet:8648fc4c-e230-41b8-af3e-daabdcf02888[]
----
...
NOTE: Set the `SUBNETS_JSON` variable with the subnet IDs from the previous step. You must wrap the value in single quotes to prevent the shell from interpreting the brackets and quotes as special characters.
