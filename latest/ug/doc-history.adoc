...
The following table describes major updates and new features for the Amazon EKS User Guide. To receive document history notifications, you can use the following URL with an RSS reader:
