...
kubectl describe [.replaceable]`custom-kind my-instance`
...
kubectl get [.replaceable]`custom-kind my-instance` -o jsonpath='{.status.conditions}'

# Check instance state
kubectl get [.replaceable]`custom-kind my-instance` -o jsonpath='{.status.state}'
----
...
kubectl get [.replaceable]`custom-kind my-instance` -o jsonpath='{.status}'
...
kubectl describe [.replaceable]`custom-kind my-instance` | grep -A 5 "Validation"
----
