...
* For creating and managing resources, see the https://aws-controllers-k8s.github.io/docs/guides/create-resource[ACK usage guide^].
* For complete API documentation for all services, see the https://aws-controllers-k8s.github.io/docs/api-reference[ACK API reference^].
* For comprehensive user documentation, see the https://aws-controllers-k8s.github.io/docs/[ACK documentation^].
