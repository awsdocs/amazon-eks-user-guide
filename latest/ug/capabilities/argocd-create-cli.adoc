...
Create the capability with Identity Center integration. Replace [.replaceable]`region-code` with the {aws} Region where your cluster is located and [.replaceable]`my-cluster` with your cluster name and [.replaceable]`idc-region-code` with the region code where you IAM Identity Center has been configured:
