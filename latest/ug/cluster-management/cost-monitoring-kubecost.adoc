...
For more information about Kubecost, see the https://docs.kubecost.com[Kubecost] documentation and <<cost-monitoring-faq, Frequently asked questions>>.
...
* https://docs.kubecost.com/install-and-configure/install/environment[Amazon EKS 1.31 would be reuquired] if you are about to install kubecost v2.
...
helm upgrade -i kubecost \
    ...
    -f https://raw.githubusercontent.com/kubecost/cost-analyzer-helm-chart/refs/tags/v1.108.1/cost-analyzer/values-eks-cost-monitoring.yaml
----
+
