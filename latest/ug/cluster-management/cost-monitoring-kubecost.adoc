...
After the _Amazon EKS optimized Kubecost bundle_ setup is complete, you can access the Kubecost dashboard. For more information, see <<cost-monitoring-kubecost-dashboard>>.
