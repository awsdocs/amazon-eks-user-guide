...
No. You can use _Amazon EKS optimized Kubecost custom bundle_ at no additional charge. If you want additional Kubecost capabilities that aren't included in this bundle, you can buy an Enterprise License of Kubecost through the {aws} Marketplace, or from Kubecost directly.

*Is support available for _Amazon EKS optimized Kubecost custom bundle_?*

Yes, only if you are using the _Amazon EKS optimized Kubecost custom bundle_.

*How do I get support for _Amazon EKS optimized Kubecost custom bundle_?*
...
No. _Amazon EKS optimized Kubecost custom bundle_ only compatible with Amazon EKS clusters.
