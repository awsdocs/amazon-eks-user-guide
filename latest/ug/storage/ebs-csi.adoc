...
[source,json]
----
include::../iam-json/storage/ebs-csi-policy-1.json[]
----
...
[source,json]
----
include::../iam-json/storage/ebs-csi-policy-2.json[]
----
.. Choose *Next: Tags*.
...
[source,json]
----
include::../iam-json/storage/ebs-csi-policy-3.json[]
----
...
[source,json]
----
include::../iam-json/storage/ebs-csi-policy-4.json[]
----
.. Create the policy. You can change [.replaceable]`KMS_Key_For_Encryption_On_EBS_Policy` to a different name. However, if you do, make sure to change it in later steps, too.
+
[source,bash,subs="verbatim,attributes"]
