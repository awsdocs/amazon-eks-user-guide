...
[source,json]
----
include::../iam-json/storage/s3-csi-create-policy-1.json[]
----
+
...
[source,json]
----
include::../iam-json/storage/s3-csi-create-policy-2.json[]
----
. Choose *Next*.
...
[source,json]
----
include::../iam-json/storage/s3-csi-create-policy-3.json[]
----
