...
. Set a few variables to use in the remaining steps. Replace [.replaceable]`my-csi-fsx-cluster` with the name of the test cluster you want to create and [.replaceable]`region-code` with the {aws} Region that you want to create your test cluster in.
+
