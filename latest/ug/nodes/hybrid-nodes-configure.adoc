...
This chapter describes how to configure Container Network Interfaces (CNI), add-ons, webhooks, and proxy settings for hybrid nodes. For the complete list of the EKS and community add-ons that are compatible with hybrid nodes, see <<hybrid-nodes-add-ons>>.
