...
* You can create new Amazon EKS clusters to use Amazon EKS Hybrid Nodes. Or, you can update an existing Amazon EKS cluster to add the hybrid node configuration.
