...
. Add a topology zone label for each of your hybrid nodes. This can alternatively be done at the `nodeadm init` phase. Note, cloud nodes automatically get a topology zone label applied to them.
+
