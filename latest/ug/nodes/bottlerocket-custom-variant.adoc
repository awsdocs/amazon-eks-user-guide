...
[abstract]
--
This topic explains how to build a custom Bottlerocket variant by swapping the NVIDIA driver branch. It also shows how to register the result as a private Amazon Machine Image (AMI) for Amazon EKS graphics processing unit (GPU) workloads.
--
