...
Because Bottlerocket is fully open-source, you can create a custom variant that meets these needs. This topic shows how to build a custom Bottlerocket variant. You clone an existing variant, swap the NVIDIA driver from the R580 branch to R595 (version 595.71.05), build the image, and register it as a private AMI.
