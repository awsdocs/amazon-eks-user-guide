...
See the https://github.com/tbuatois/bottlerocket/tree/nvidia-r595-variants[community-contributed fork] on the GitHub website for a Bottlerocket branch that is ready to build with NVIDIA driver version 595. This fork is not officially supported by {aws} and we recommend that you confirm it conforms to your requirements.
====
