...
* `[.replaceable]`YOUR_NODE_ROLE`` — The IAM role name for the Auto Mode nodes (the same role used in the cluster's compute config).
...
aws eks create-nodegroup \
  ...
  --subnets [.replaceable]`SUBNET_ID_1` [.replaceable]`SUBNET_ID_2` \
