...
[source,bash,subs="verbatim,attributes,quotes"]
----
helm install cilium https://public.ecr.aws/eks/cilium/cilium \
...
[source,bash,subs="verbatim,attributes"]
----
helm install cilium-preflight https://public.ecr.aws/eks/cilium/cilium --version CILIUM_VERSION \
  --namespace=kube-system \
...
[source,bash,subs="verbatim,attributes,quotes"]
----
helm upgrade cilium https://public.ecr.aws/eks/cilium/cilium --version [.replaceable]`CILIUM_VERSION` \
  --namespace kube-system \
