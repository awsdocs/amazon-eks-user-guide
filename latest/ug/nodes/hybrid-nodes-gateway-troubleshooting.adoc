...
aws ec2 describe-instance-attribute \
  --instance-id [.replaceable]`GATEWAY_INSTANCE_ID` \
...
[source,bash,subs="verbatim,attributes"]
----
aws ec2 describe-route-tables --route-table-ids [.replaceable]`ROUTE_TABLE_ID`
----
...
[source,bash,subs="verbatim,attributes"]
----
kubectl logs -n eks-hybrid-nodes-gateway [.replaceable]`LEADER_POD` | grep -i "route table"
----
+
...
[source,bash,subs="verbatim,attributes"]
----
kubectl logs -n eks-hybrid-nodes-gateway [.replaceable]`LEADER_POD`
----
...
[source,bash,subs="verbatim,attributes"]
----
kubectl get pod -n eks-hybrid-nodes-gateway [.replaceable]`LEADER_POD` -o jsonpath='{.spec.containers[0].env}' | jq .
----
+
...
[source,bash,subs="verbatim,attributes"]
----
kubectl describe pod -n eks-hybrid-nodes-gateway [.replaceable]`LEADER_POD`
----
+
...
[source,bash,subs="verbatim,attributes"]
----
kubectl logs -n eks-hybrid-nodes-gateway [.replaceable]`LEADER_POD` | grep -i "leader\|lease"
----
+
