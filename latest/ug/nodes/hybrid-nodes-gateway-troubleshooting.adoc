...
GATEWAY_NODE=$(kubectl get pod <leader-pod-name> -n eks-hybrid-nodes-gateway -o jsonpath='{.spec.nodeName}')
...
[source,bash,subs="verbatim,attributes"]
----
kubectl logs -n eks-hybrid-nodes-gateway <leader-pod-name> | grep -i "route table"
----
+
...
* Required environment variables (`NODE_IP`, `VPC_CIDR`, `POD_CIDRS`, `ROUTE_TABLE_IDS`) are not set.
...
[source,bash,subs="verbatim,attributes"]
----
kubectl logs -n eks-hybrid-nodes-gateway <pod-name>
----
...
[source,bash,subs="verbatim,attributes"]
----
kubectl get pod -n eks-hybrid-nodes-gateway <pod-name> -o jsonpath='{.spec.containers[0].env}' | jq .
----
+
...
[source,bash,subs="verbatim,attributes"]
----
kubectl describe pod -n eks-hybrid-nodes-gateway <pod-name>
----
+
...
[source,bash,subs="verbatim,attributes"]
----
kubectl logs -n eks-hybrid-nodes-gateway <pod-name> | grep -i "leader\|lease"
----
+
