...
Alternatively, you can <<eks-ami-build-scripts>> until the EOS date (November 26, 2025). Additionally, you can build a custom AMI with an Amazon Linux 2 base instance until the Amazon Linux 2 EOS date (June 30, 2026)--an additional 6-month 'ramp-down phase' with critical CVE support will be provided for Amazon Linux to allow customers to upgrade their workloads to AL2023.
