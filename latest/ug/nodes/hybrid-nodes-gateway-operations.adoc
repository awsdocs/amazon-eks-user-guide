...
|[.replaceable]`HYBRID_POD_CIDR`
|[.replaceable]`eni-LEADER_ENI_ID`
|active
|===
...
----
kubectl port-forward -n eks-hybrid-nodes-gateway [.replaceable]`POD_NAME` 8088:8088 &
