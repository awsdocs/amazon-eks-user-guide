...
The Amazon EKS Hybrid Nodes gateway is available in all {aws} Regions where EKS Hybrid Nodes is available, except China Regions. For the current list of supported Regions, see <<hybrid-nodes-overview>>.
...
include::hybrid-nodes-gateway-cni.adoc[leveloffset=+1]
