...
+
To configure _Runtime Monitoring_, you install the GuardDuty agent to your cluster as an _Amazon EKS add-on_. For more information about the add-on, see <<workloads-add-ons-available-eks>>.
+
