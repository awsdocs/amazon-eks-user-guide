...
= Monitor workload traffic in Amazon EKS with Container Network Observability 
...
Important note: The scraping of metrics from the NFM agent and the process of the NFM agent pushing these metrics to the NFM backend are independent processes. 
