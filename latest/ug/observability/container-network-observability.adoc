...
_Important note: The scraping of system metrics from the NFM agent and the process of the NFM agent pushing flow-level metrics to the NFM backend are independent processes._ 

===== Supported System Metrics 

_Important note: system metrics are exported in https://openmetrics.io/[OpenMetrics] format._
