...
|ADOT can collect and send correlated metrics, trace data, and metadata to {aws} monitoring services or partners. It can be set up through CloudWatch Container Insights.
...
include::container-network-observability.adoc[leveloffset=+1]
