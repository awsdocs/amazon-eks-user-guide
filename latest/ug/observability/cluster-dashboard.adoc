...
** The steps to access the management account depend on how you have configured your {aws} Organization. For example, you might access the management account via {aws} link:iam/identity-center/IAM[Identity Center,type="marketing"] or link:https://www.okta.com/partners/aws/[Okta]. 
