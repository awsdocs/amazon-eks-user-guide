...
[source,json]
----
include::../iam-json/observability/cluster-dashboard-orgs-policy-1.json[]
----
...
[source,json]
----
include::../iam-json/observability/cluster-dashboard-orgs-policy-2.json[]
----
...
[source,json]
----
include::../iam-json/observability/cluster-dashboard-orgs-policy-3.json[]
----
