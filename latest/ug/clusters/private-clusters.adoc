...
+
We recommend that you link:vpc/latest/privatelink/interface-endpoints.html[enable private DNS names,type="documentation"] for your VPC endpoints, that way workloads can continue using public {aws} service endpoints without issues.
+
