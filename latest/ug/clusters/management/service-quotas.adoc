...
* Pod Identity associations per cluster is [.noloc]`1000` in each supported region and this quota isn't adjustable.
...
📝 https://github.com/search?q=repo:awsdocs/amazon-eks-user-guide+&#91;&#91;service-quotas,&type=code[Edit this page on GitHub]