...
| `1.31.2`
| `eks.12`
| New platform version security fixes and enhancements to control plane observability. To learn more about the control plane observability, see link:blogs/containers/amazon-eks-enhances-kubernetes-control-plane-observability/[Amazon EKS enhances performance observability,type="blog"].
| November 15, 2024
