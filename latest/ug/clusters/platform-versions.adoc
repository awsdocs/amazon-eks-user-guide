...
[[platform-versions-1.32,platform-versions-1.32.title]]
...
📝 https://github.com/search?q=repo:awsdocs/amazon-eks-user-guide+&#91;&#91;platform-versions,&type=code[Edit this page on GitHub]