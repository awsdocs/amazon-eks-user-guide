...
You can use an override flag to bypass upgrade insights checks. This can be useful when you believe you have addressed issues and the insight status is no longer accurate, or if you are operating in a developer environment. For more information, see <<update-cluster>>.
