...
[[version-cli,version-cli.title]]
== Get version information with {AWS} CLI

You can use the {aws} CLI to get information about Kubernetes versions available on EKS, such as the end date fo Standard Support. 
