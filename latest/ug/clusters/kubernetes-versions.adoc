...
+
NOTE: Extended Support for Amazon EKS optimized Windows AMIs that are published by {aws} isn't available for Kubernetes version `1.23` but is available for Kubernetes version `1.24` and higher.
