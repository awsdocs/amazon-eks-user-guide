...
:info_titleabbrev: Provisioned Control Plane
...
To get started, see https://docs.aws.amazon.com/eks/latest/userguide/eks-mcp-tool-configurations.html[Getting Started with the Amazon EKS Provisioned Control Plane]
