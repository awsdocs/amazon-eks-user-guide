...
* If your cluster has any EKS Capabilities (ACK, Argo CD, or kro), you must delete them before you can delete the cluster. For more information, see <<capabilities-delete>>.
...
.. Choose the *Capabilities* tab and choose a capability to delete. Choose *Delete capability*, enter the name of the capability, and then choose *Delete*. Delete all capabilities in the cluster. For more information, see <<capabilities-delete>>.
...
----
.. Delete each capability with the following command. Delete all capabilities in the cluster. For more information, see <<capabilities-delete>>.
+
[source,bash,subs="verbatim,attributes"]
----
