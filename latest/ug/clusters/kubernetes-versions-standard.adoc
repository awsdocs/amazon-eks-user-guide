...
[[kubernetes-1.32,kubernetes-1.32.title]]
== [.noloc]`Kubernetes` 1.32

[.noloc]`Kubernetes` `1.32` is now available in Amazon EKS. For more information about [.noloc]`Kubernetes` `1.32`, see the https://kubernetes.io/blog/2024/12/13/kubernetes-v1-32-release/[official release announcement].
...
For the complete [.noloc]`Kubernetes` `1.32` changelog, see https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.32.md
...
NOTE: This update applies to EKS-optimized AL2 AMIs. For more information about the operating system itself, see link:https://aws.amazon.com/amazon-linux-2/faqs/["Amazon Linux 2 FAQs", type="marketing"]
