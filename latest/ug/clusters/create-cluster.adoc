...
. If you plan to deploy workloads to your cluster that use Amazon EBS volumes , and you created a `1.23` or later cluster, then you must install the <<ebs-csi,Amazon EBS CSI>> to your cluster before deploying the workloads.
