...
** *Node pools* -- Determine if you want to use the built-in node pools. For more information, see <<set-builtin-node-pools>>.
...
----
include::iam_snippet:ec7fbb57-62f5-4aef-8c1f-f24b1fa7654d[]
----
...
[source,json,subs="verbatim,attributes"]
----
include::iam_snippet:f2d6ec6e-f3d9-46bb-930f-5ec41ae792ab[]
----
