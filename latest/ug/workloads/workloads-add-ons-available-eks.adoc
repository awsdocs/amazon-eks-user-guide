...
[[addons-hyperpod,addons-hyperpod.title]]
...
[[addons-network-flow,addons-network-flow.title]]
...
[[add-ons-eks-node-monitoring-agent,add-ons-eks-node-monitoring-agent.title]]
...
[[add-ons-eks-node-monitoring-agent-iam-permissions,add-ons-eks-node-monitoring-agent-iam-permissions.title]]
=== Required IAM permissions

This add-on doesn't require additional permissions.

[[add-ons-eks-node-monitoring-agent-information,add-ons-eks-node-monitoring-agent-information.title]]
=== Additional information
...
📝 https://github.com/search?q=repo:awsdocs/amazon-eks-user-guide+&#91;&#91;workloads-add-ons-available-eks,&type=code[Edit this page on GitHub]