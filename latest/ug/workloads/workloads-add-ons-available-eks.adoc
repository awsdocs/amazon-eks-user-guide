...
|<<add-ons-aws-ec2-instance-store-csi-driver>>
|EC2
...
|<<addons-hyperpod-inference-operator>>
|EC2, EKS Auto Mode
...
[abstract]
--
Learn about the Amazon EC2 Instance Store CSI driver Amazon EKS add-on.
--
...
[#add-ons-aws-ec2-instance-store-csi-driver-iam-permissions]
=== Required IAM permissions
...
[#add-ons-aws-ec2-instance-store-csi-driver-information]
=== Additional information

To learn more about the add-on, see <<lis-csi>>.
...
* *For Amazon EFS file systems only*: Attach the link:aws-managed-policy/latest/reference/AmazonEFSCSIDriverPolicy.html[AmazonEFSCSIDriverPolicy,type="documentation"] managed policy.
...
[NOTE]
====
The above example only configures `efs-csi-controller-sa`. If you are using Amazon S3 file systems, you also need to configure `efs-csi-node-sa`. See <<s3files-create-iam-resources>> for the complete S3 Files IAM setup.
====
...
For detailed installation instructions for each dependency, see link:sagemaker/latest/dg/sagemaker-hyperpod-model-deployment-setup.html[Installing the inference operator,type="documentation"].
...
For more information, see link:sagemaker/latest/dg/sagemaker-hyperpod-model-deployment-setup.html[Installing the inference operator,type="documentation"].

=== Additional information

To learn more about the Amazon SageMaker HyperPod inference operator, see link:sagemaker/latest/dg/sagemaker-hyperpod-model-deployment.html[SageMaker HyperPod inference operator,type="documentation"].

For troubleshooting information, see link:sagemaker/latest/dg/sagemaker-hyperpod-model-deployment-ts.html[Troubleshooting SageMaker HyperPod model deployment,type="documentation"].
