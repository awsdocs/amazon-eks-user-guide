...
. View the details of one of the Pods listed in the output when you <<sample-app-view-namespace-win,viewed the namespace>> in a previous step. Replace [.replaceable]`65b7669776-m6qxz` with the value returned for one of your Pods.
+
[source,bash,subs="verbatim,attributes"]
----
