...
----
. Generate certs for the VPA Admission Controller with the following command.
+
[source,bash,subs="verbatim,attributes"]
----
...
📝 https://github.com/search?q=repo:awsdocs/amazon-eks-user-guide+&#91;&#91;vertical-pod-autoscaler,&type=code[Edit this page on GitHub]
