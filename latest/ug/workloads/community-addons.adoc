...
This add-on does not require IAM permissions in the default configuration. However, you may need to grant this add-on IAM permissions if you configure S3 or CloudWatch as an output location. For more information, see <<update-addon-role>>.
