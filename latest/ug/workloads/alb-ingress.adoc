...
+
If you're using multiple security groups attached to worker nodes, exactly one security group must be tagged as follows. Replace [.replaceable]`my-cluster` with your cluster name.
+
** *Key*
...
. When you finish experimenting with your sample application, delete it by running one of the following commands.
+
