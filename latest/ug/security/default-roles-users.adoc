...
[[default-role-users-console,default-role-users-console.title]]
...
[[default-role-users-kubectl,default-role-users-kubectl.title]]
== Kubectl
...
📝 https://github.com/search?q=repo:awsdocs/amazon-eks-user-guide+&#91;&#91;default-roles-users,&type=code[Edit this page on GitHub]