...
----
include::iam_snippet:8a891a66-8698-44f2-a057-bbae3d155c47[]
----
...
[source,json,subs="verbatim,attributes"]
----
include::iam_snippet:2e26040d-2a2b-47d2-927c-2f51254195af[]
----
.. Create a file named `eks-connector-agent-policy.json` that contains the following JSON to use for the IAM role.
+
[source,json,subs="verbatim,attributes"]
----
include::iam_snippet:7e131b38-c620-4f45-9c4d-cec5c9b40408[]
----
