...
[source,json]
----
include::../../iam-json/security/iam-reference/connector-iam-role-policy-1.json[]
----
...
[source,json]
----
include::../../iam-json/security/iam-reference/connector-iam-role-policy-2.json[]
----
.. Create a file named `eks-connector-agent-policy.json` that contains the following JSON to use for the IAM role.
+
[source,json]
----
include::../../iam-json/security/iam-reference/connector-iam-role-policy-3.json[]
----
