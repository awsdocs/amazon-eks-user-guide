...
* *`ssm`, `ssmmessages`* – Allows Amazon EC2 Systems Manager connection to the control plane instance, which is used by Amazon EKS to communicate and manage the local cluster in your account.
...
|Added permission to <<security-iam-awsmanpol-amazonekslocaloutpostclusterpolicy>>
|Added `ssmmessages:OpenDataChannel` permission to `AmazonEKSLocalOutpostClusterPolicy`.
|July 7, 2025
