...
To view the latest version of the JSON policy document, see link:aws-managed-policy/latest/reference/AmazonEKSMCPReadOnlyAccess.html#AmazonEKSMCPReadOnlyAccess-json[AmazonEKSMCPReadOnlyAccess,type="documentation"] in the {aws} Managed Policy Reference Guide.
...
|Introduced new `AmazonEKSMCPReadOnlyAccess` policy.
|November 20, 2025
