...
[source,json]
----
include::../../iam-json/security/iam-reference/auto-cluster-iam-role-policy-1.json[]
----
...
[source,json]
----
include::../../iam-json/security/iam-reference/auto-cluster-iam-role-policy-2.json[]
----
