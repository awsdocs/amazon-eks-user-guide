...
:info_titleabbrev: Fargate profile role
...
📝 https://github.com/search?q=repo:awsdocs/amazon-eks-user-guide+&#91;&#91;using-service-linked-roles-eks-fargate,&type=code[Edit this page on GitHub]