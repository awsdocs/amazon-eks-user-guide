...
----
include::iam_snippet:c90cfc65-d638-4a20-a06a-47e7d2f69e7e[]
----
...
[source,json,subs="verbatim,attributes"]
----
include::iam_snippet:b1f909cd-2c64-4c9b-b5c5-186f78c6aa5a[]
----
...
[source,json,subs="verbatim,attributes"]
----
include::iam_snippet:4e925c83-85eb-4a95-8b72-1631224902bb[]
----
...
[source,json,subs="verbatim,attributes"]
----
include::iam_snippet:b19597bc-301e-4c81-94b5-b8fe30558df0[]
----
...
[source,json,subs="verbatim,attributes"]
----
include::iam_snippet:8287e107-08f4-473b-99f4-5d1c39273a86[]
----
...
[source,json,subs="verbatim,attributes"]
----
include::iam_snippet:dbfd52f1-1fc5-4ab5-a4ac-7d2c5fcfa7c2[]
----

[#policy-cancel-update]
== Cancel a cluster update (rollback)

// TODO: Verify IAM action name is exactly "eks:CancelUpdate" — could be eks:CancelClusterUpdate or similar. Verify tag-based conditions are supported for this action.
...
For more information about the full cluster rollback process, see <<rollback-cluster>>.