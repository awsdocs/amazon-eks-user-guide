...
[source,json]
----
include::../../iam-json/security/iam-reference/security-iam-id-based-policy-examples-policy-1.json[]
----
...
[source,json]
----
include::../../iam-json/security/iam-reference/security-iam-id-based-policy-examples-policy-2.json[]
----
...
[source,json]
----
include::../../iam-json/security/iam-reference/security-iam-id-based-policy-examples-policy-3.json[]
----
...
[source,json]
----
include::../../iam-json/security/iam-reference/security-iam-id-based-policy-examples-policy-4.json[]
----
...
[source,json]
----
include::../../iam-json/security/iam-reference/security-iam-id-based-policy-examples-policy-5.json[]
----