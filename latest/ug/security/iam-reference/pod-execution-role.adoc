...
[source,json]
----
include::../../iam-json/security/iam-reference/pod-execution-role-policy-1.json[]
----
+
...
[source,json]
----
include::../../iam-json/security/iam-reference/pod-execution-role-policy-2.json[]
----
...
[source,json]
----
include::../../iam-json/security/iam-reference/pod-execution-role-policy-3.json[]
----
