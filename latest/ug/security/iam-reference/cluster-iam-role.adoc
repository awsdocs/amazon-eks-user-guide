...
[source,json]
----
include::../../iam-json/security/iam-reference/cluster-iam-role-policy-1.json[]
----
...
[source,json]
----
include::../../iam-json/security/iam-reference/cluster-iam-role-policy-2.json[]
----
...
[source,json]
----
include::../../iam-json/security/iam-reference/cluster-iam-role-policy-3.json[]
----
