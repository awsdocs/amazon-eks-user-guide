...
You can append a successor CA yourself at any time using the {aws} CLI, EKS API, Console, or infrastructure as code (IaC) such as CloudFormation, as long as your cluster is in an active state. If you do not, {aws} will automatically append one on your behalf.
...
You can monitor CA rotation progress across your fleet using the {aws} CLI, EKS API, Console, or infrastructure as code (IaC) such as CloudFormation.
