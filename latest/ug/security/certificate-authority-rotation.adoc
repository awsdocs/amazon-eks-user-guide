...
{aws} automatically updates EKS Capabilities (such as managed Argo CD, ACK, and Kro) to trust the successor CA. These managed resources communicate with your cluster's API server and are updated as part of the CA distribution process. No action is required from you for EKS Capabilities.
