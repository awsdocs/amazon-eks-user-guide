...
| 1.32 | Only minimal type is available | v1.32.3-minimal-eksbuild.7
| 1.31 | Only minimal type is available | v1.31.7-minimal-eksbuild.7
| 1.30 | Only minimal type is available | v1.30.11-minimal-eksbuild.5
| 1.29 | Only minimal type is available | v1.29.15-minimal-eksbuild.5
| 1.28 | Only minimal type is available | v1.28.15-minimal-eksbuild.20
| 1.27 | Only minimal type is available | v1.27.16-minimal-eksbuild.30
| 1.26 | Only minimal type is available | v1.26.15-minimal-eksbuild.35
| 1.25 | Only minimal type is available | v1.25.16-minimal-eksbuild.38 
|===
