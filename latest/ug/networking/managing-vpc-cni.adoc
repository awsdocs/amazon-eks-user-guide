[.topic]
[#managing-vpc-cni]
= Assign IPs to [.noloc]`Pods` with the Amazon VPC CNI
...
| 1.31 | v1.19.2-eksbuild.1
| 1.30 | v1.19.2-eksbuild.1
| 1.29 | v1.19.2-eksbuild.1
| 1.28 | v1.19.2-eksbuild.1
| 1.27 | v1.19.2-eksbuild.1
| 1.26 | v1.19.2-eksbuild.1
| 1.25 | v1.19.2-eksbuild.1
| 1.24 | v1.19.2-eksbuild.1
|===
...
📝 https://github.com/search?q=repo%3Aawsdocs%2Famazon-eks-user-guide+%5B%23managing-vpc-cni%5D&type=code[Edit this page on GitHub]