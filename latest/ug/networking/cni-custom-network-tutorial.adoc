...
+
.... Determine the maximum number of Pods for your nodes based on your instance type. For more information, see <<max-pods-precedence>>. Note the value for use in the next step.
