...
For Amazon EKS to scale your CoreDNS deployment, there is one prerequisite for basic features, and an additional prerequisite for the advanced scaling parameters.
