...
You can alternatively run the following {aws} CLI command. Replace `my-cluster` with the name of your cluster and the IAM role ARN with the role that you are using.
[source,shell,subs="verbatim,attributes"]
----
