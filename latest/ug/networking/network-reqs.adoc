...
* The subnets can't reside in {aws} Outposts, {aws} Wavelength, or an {aws} Local Zone. However, if you have them in your VPC, you can deploy <<worker,self-managed nodes>> and [.noloc]`Kubernetes` resources to these types of subnets.
