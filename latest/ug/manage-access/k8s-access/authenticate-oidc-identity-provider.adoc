...
* The number of OIDC identity providers you can associate with a cluster depends on the cluster's Kubernetes version:
+
** On clusters running Kubernetes version 1.32 or later, you can associate up to 10 OIDC identity providers. The combined size of all OIDC provider configurations must be less than 12 KB.
** On clusters running a version earlier than 1.32, you can associate only one OIDC identity provider.
