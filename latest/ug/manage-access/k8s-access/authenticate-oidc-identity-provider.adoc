...
[NOTE]
====
Associating or disassociating an OIDC identity provider is a cluster update. The cluster enters the `UPDATING` state, and it can take approximately 15–20 minutes for the change to be fully applied to the cluster's API servers.
====
