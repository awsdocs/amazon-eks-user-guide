...
[source,json]
----
include::../../iam-json/manage-access/k8s-access/authenticate-oidc-identity-provider-policy-1.json[]
----
...
[source,json]
----
include::../../iam-json/manage-access/k8s-access/authenticate-oidc-identity-provider-policy-2.json[]
----
