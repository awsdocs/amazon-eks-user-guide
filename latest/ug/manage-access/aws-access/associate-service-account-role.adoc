...
----
include::iam_snippet:8bd1c472-a436-45e3-9074-1a8c53fd2ef0[]
----
...
IMPORTANT: If the role or service account already exists, the previous command might fail. `eksctl` has different options that you can provide in those situations. For more information run `eksctl create iamserviceaccount --help`.
...
[source,json,subs="verbatim,attributes"]
----
include::iam_snippet:5f6a2e0b-00ab-4b9b-aa41-e700048754d7[]
----
...
----
include::iam_snippet:ccc47547-ea4d-4a0e-b3fa-2a68aa171d30[]
----
...
[source,json,subs="verbatim,attributes",role="nocopy"]
----
include::iam_snippet:f4c9d9e0-bbed-485d-baf3-15faa91a796a[]
----
+
