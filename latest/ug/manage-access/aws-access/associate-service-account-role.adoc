...
[source,json]
----
include::../../iam-json/manage-access/aws-access/associate-service-account-role-policy-1.json[]
----
...
[source,json]
----
include::../../iam-json/manage-access/aws-access/associate-service-account-role-policy-2.json[]
----
+
