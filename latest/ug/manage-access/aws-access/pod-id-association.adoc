...
[source,json]
----
include::../../iam-json/manage-access/aws-access/pod-id-association-policy-1.json[]
----
+
...
[source,json]
----
include::../../iam-json/manage-access/aws-access/pod-id-association-policy-2.json[]
----
...
[source,json]
----
include::../../iam-json/manage-access/aws-access/pod-id-association-policy-3.json[]
----
+
