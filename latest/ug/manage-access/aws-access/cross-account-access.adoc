...
[source,json]
----
include::../../iam-json/manage-access/aws-access/cross-account-access-policy-1.json[]
----
...
[source,json]
----
include::../../iam-json/manage-access/aws-access/cross-account-access-policy-2.json[]
----
...
[source,json]
----
include::../../iam-json/manage-access/aws-access/cross-account-access-policy-3.json[]
----
