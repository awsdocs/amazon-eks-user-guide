...
[source,json]
----
include::../../iam-json/manage-access/aws-access/pod-id-assign-target-role-policy-1.json[]
----
...
[source,json]
----
include::../../iam-json/manage-access/aws-access/pod-id-assign-target-role-policy-2.json[]
----
...
[source,json]
----
include::../../iam-json/manage-access/aws-access/pod-id-assign-target-role-policy-3.json[]
----
