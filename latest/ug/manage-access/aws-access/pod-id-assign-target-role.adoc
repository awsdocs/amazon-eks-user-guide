...
7. In the policy editor, replace the default JSON with your permission policy. Replace the placeholder value for role name and `22222222` in the IAM role ARN with your Target IAM Role. For example:
    ...
    "Statement": [
        {
            ...
            "Resource": "arn:aws:iam::22222222:role/eks-pod-identity-aws-resources"
        }
    ]
}
----
