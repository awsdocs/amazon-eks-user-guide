...
+ You can run the following AWS System Manager Automation [runbook](https://docs.aws.amazon.com/systems-manager-automation-runbooks/latest/userguide/automation-awssupport-troubleshooteksworkernode.html), which could help you identify and troubleshoot common causes that prevent worker nodes from joining a cluster.
