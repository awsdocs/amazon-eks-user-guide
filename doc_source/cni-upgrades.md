...
+ Use the following command to print your cluster's CNI version:
  ...
  In this example output, the CNI version is 1\.6\.3, which is earlier than the latest patch for version 1\.7\.5\. Use the following procedure to upgrade the CNI\.
