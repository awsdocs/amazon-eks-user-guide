...
+ The snapshot controller must be installed alongside a CSI driver with snapshot functionality\. For example, the Amazon EBS CSI driver \. For installation instructions of the Amazon EBS CSI driver, see [Store Kubernetes volumes with Amazon EBS](ebs-csi.md)\.
