...
All Amazon EKS actions are logged by CloudTrail and are documented in the [Amazon EKS API Reference](http://docs.aws.amazon.com//eks/latest/APIReference/)\. For example, calls to the [http://docs.aws.amazon.com//eks/latest/APIReference/API_CreateCluster.html](http://docs.aws.amazon.com//eks/latest/APIReference/API_CreateCluster.html), [http://docs.aws.amazon.com//eks/latest/APIReference/API_ListClusters.html](http://docs.aws.amazon.com//eks/latest/APIReference/API_ListClusters.html) and [http://docs.aws.amazon.com//eks/latest/APIReference/API_DeleteCluster.html](http://docs.aws.amazon.com//eks/latest/APIReference/API_DeleteCluster.html) sections generate entries in the CloudTrail log files\.
...
The following example shows a CloudTrail log entry that demonstrates the [http://docs.aws.amazon.com//eks/latest/APIReference/API_CreateCluster.html](http://docs.aws.amazon.com//eks/latest/APIReference/API_CreateCluster.html) action\.
