...
**Prerequisite**  
`eksctl` version `0.143.0` or later installed on your computer\. To install or update to it, see [Installing or updating `eksctl`](eksctl.md)\.
