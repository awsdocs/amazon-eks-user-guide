...
+ Node \(Version 2\) — [2\.521\.0](https://github.com/aws/aws-sdk-js/releases/tag/v2.521.0)
+ Node \(Version 3\) — [3\.15\.0](https://github.com/aws/aws-sdk-js-v3/releases/tag/v3.15.0)
