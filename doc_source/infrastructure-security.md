...
If you create your VPC and node groups with the AWS CloudFormation templates provided in the walkthrough, then your control plane and node security groups are configured with our recommended settings\.
