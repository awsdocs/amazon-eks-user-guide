...
1. Launch a new node group by following the steps outlined in [Launching self\-managed Amazon Linux nodesLaunching self\-managed Bottlerocket nodes](launch-workers.md)\.
