...
This procedure requires `eksctl` version `0.117.0` or later\. You can check your version with the following command:
...
1. Drain each of the nodes that you want to remove from your cluster with the following command:
   ...
   If you're upgrading your nodes to a new Kubernetes version, identify and drain all of the nodes of a particular Kubernetes version \(in this case, `1.21`\) with the following code snippet\.
