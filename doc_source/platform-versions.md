...
When a new Kubernetes minor version is available in Amazon EKS, such as 1\.31, the initial Amazon EKS platform version for that Kubernetes minor version starts at `eks.1`\. However, Amazon EKS releases new platform versions periodically to enable new Kubernetes control plane settings and to provide security fixes\.
...
## Kubernetes version `1.31`<a name="platform-versions-1.31"></a>
...
| --- | --- | --- | --- | 
|  `1.31.0`  |  `eks.2`  |  Initial release of Kubernetes version `1.31` for EKS\. For more information, see [Kubernetes 1\.31](kubernetes-versions-standard.md#kubernetes-1.31)\.  | September 26, 2024 | 
...
|  `1.26.2`  |  `eks.1`  |  Initial release of Kubernetes version `1.26` for EKS\. For more information, see [Kubernetes 1\.26](kubernetes-versions-extended.md#kubernetes-1.26)\.  | April 11, 2023 | 
...
| Kubernetes version | EKS platform version | Release notes | Release date | 
| --- | --- | --- | --- | 
|  `1.23.17`  |  `eks.30`  |  New platform version with security fixes and enhancements\. | September 3, 2024 | 
|  `1.23.17`  |  `eks.29`  |  New platform version with security fixes and enhancements\. | August 28, 2024 | 
