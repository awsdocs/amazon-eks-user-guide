...
The recommended and latest version work with all Amazon EKS supported Kubernetes versions\.
   ...
   ```
   kubectl apply -f https://raw.githubusercontent.com/aws/amazon-vpc-cni-k8s/v1.11.3/config/master/cni-metrics-helper-us-gov-east-1.yaml
   ```

   AWS GovCloud \(US\-West\) \(`us-gov-west-1`\)

   ```
   kubectl apply -f https://raw.githubusercontent.com/aws/amazon-vpc-cni-k8s/v1.11.3/config/master/cni-metrics-helper-us-gov-west-1.yaml
   ```
   ...
   1. Download the manifest file\.
      ...
      ```
      curl -o cni-metrics-helper.yaml https://raw.githubusercontent.com/aws/amazon-vpc-cni-k8s/v1.11.3/config/master/cni-metrics-helper.yaml
      ```
