...
+ Updating managed node groups respect the pod disruption budgets that you set for your pods. For more information, see [Managed node update behavior](https://docs.aws.amazon.com/en_us/eks/latest/userguide/managed-node-update-behavior.html)\.
