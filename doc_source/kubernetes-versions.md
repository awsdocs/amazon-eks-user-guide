...
Are Amazon EKS managed node groups automatically updated along with the cluster control plane version?Are self\-managed node groups automatically updated along with the cluster control plane version?  
...
When exactly is my control plane automatically updated after the end of extended support date?Can I leave my control plane on a Kubernetes version indefinitely?  
