...
+ CoreDNS version `1.8.0` is the recommended version for Amazon EKS `1.19` clusters\. This version is installed by default in new Amazon EKS `1.19` clusters\. For more information, see [Updating the CoreDNS add\-on](managing-coredns.md)\.
...
| --- | --- | --- | --- | 
| 1\.26 | December 9, 2022 | Not supported yet | - | 
| 1\.25 | October 23, 2022 | Not supported yet | - | 
