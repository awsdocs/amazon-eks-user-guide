...
+ If you're using Security Group of Pods along with Pod Identity Agent, please have "POD_SECURITY_GROUP_ENFORCING_MODE" Flag in VPC CNI as per considerations stated at: [Security Group of Pods](https://docs.aws.amazon.com/eks/latest/userguide/security-groups-for-pods.html#sg-pods-considerations)\.
