...
1. On the **Configure *name of addon*** page:
   + Select the **Version** that you'd like to use\. The add\-on might have a recommended version\. For more information, see the [documentation](workloads-add-ons-available-eks.md) for the add\-on that you're updating\.
   ...
   + For `Code editor`, enter any add\-on specific configuration information\. For more information, see the [documentation](workloads-add-ons-available-eks.md) for the add\-on that you're updating\. 
