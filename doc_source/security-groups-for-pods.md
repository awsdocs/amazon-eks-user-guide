...
+ Security Group for Pods may lead to higher pod startup latency for pods with high churn due to rate limiting in resource controller. We are working on increasing the rate limits.
