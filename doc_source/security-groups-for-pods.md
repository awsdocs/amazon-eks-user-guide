...
+ If you're using PSP to restrict access to pod mutation, make sure to grant permission to eks-vpc-resource-controller and vpc-resource-controller(being deprecated) service accounts to annotate the pod spec.
