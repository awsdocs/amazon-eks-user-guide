...
+ An existing EFS CSI Driver is also required as storage will not be provisioned without that\. Check the [Related Issue\.](https://github.com/awslabs/mountpoint-s3-csi-driver/issues/185#issuecomment-2097980816)
