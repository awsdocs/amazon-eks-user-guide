# Store Kuberentes volumes with Amazon EBS<a name="ebs-csi"></a>
...
+ For instructions on how to add it as an Amazon EKS add\-on, see [Manage the Amazon EBS CSI driver as an add\-on](managing-ebs-csi.md)\.
...
After you installed the CSI driver with either method, you can test the functionality with a sample application\. For more information, see [Deploy a sample application using Amazon EBS](ebs-sample-app.md)\.