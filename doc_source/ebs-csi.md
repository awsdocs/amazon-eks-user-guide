...
**Note**  
The Amazon EBS CSI driver doesn't support AWS Gravitron Arm64\-based instances\.
...
+ For instructions on how to add it as a self\-managed add\-on, see [Managing the Amazon EBS CSI self\-managed add\-on](managing-ebs-csi-self-managed-add-on.md)\.