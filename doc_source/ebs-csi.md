...
+ AWS CLI version 1\.20\.40 or later or 2\.2\.37 installed on your computer\. To install or upgrade the AWS CLI, see [Installing, updating, and uninstalling the AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-install.html)\.
