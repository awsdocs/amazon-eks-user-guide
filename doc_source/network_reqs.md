...
## Adding secondary CIDR for additional node groups<a name="secondary-cidr-nodegroups"></a>

If your VPC is running out of IP addresses, you can consider associating [secondary CIDR](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html#vpc-resize) to your existing VPC. With the new associated CIDR, you can [create subnets](https://docs.aws.amazon.com/vpc/latest/userguide/working-with-vpcs.html#AddaSubnet) using a subset of the newly associated CIDR. After creating the new subnet/s, you can create additional node groups, either [managed](https://docs.aws.amazon.com/eks/latest/userguide/create-managed-node-group.html) or [self-managed](https://docs.aws.amazon.com/eks/latest/userguide/worker.html), that will use the newly associated CIDR and subnets.\
