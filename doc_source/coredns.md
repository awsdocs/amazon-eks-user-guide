...
1. Deploy CoreDNS to your cluster\.
   ...
   1. Download the CoreDNS manifest from the Amazon EKS resource bucket\.
      ...
      ```
      curl -o dns.yaml https://amazon-eks.s3.us-west-2.amazonaws.com/cloudformation/2020-06-10/dns.yaml
      ```
