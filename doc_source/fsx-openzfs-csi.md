...
The Amazon FSx for OpenZFS Container Storage Interface \(CSI\) driver provides a CSI interface that allows Amazon EKS clusters to manage the life cycle of Amazon FSx for OpenZFS volumes\. To deploy the Amazon FSx for OpenZFS CSI driver to your Amazon EKS cluster, see [aws\-fsx\-openzfs\-csi\-driver](https://github.com/kubernetes-sigs/aws-fsx-openzfs-csi-driver) on GitHub\.