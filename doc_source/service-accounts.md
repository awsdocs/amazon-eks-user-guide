...
+ Amazon VPC CNI and CNI metrics helper plugins version 1\.8\.0 and later\. To check your current version or update it, see [Managing the Amazon VPC CNI add\-on](managing-vpc-cni.md) and [Amazon VPC CNI plugin for Kubernetes metrics helper](cni-metrics-helper.md)\.
