...
+ Fluentd plugin image version [1.14.6-1.2] (https://hub.docker.com/r/fluent/fluentd/tags?page=1&name=v1.14.6-1.2) or later, and Fluentd plugin version [2.11.1] (https://rubygems.org/gems/fluent-plugin-kubernetes_metadata_filter/versions/2.11.1) or later. 