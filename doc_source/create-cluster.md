...
**Prerequisites**
+ `eksctl` version 0\.38\.0\-rc\.0 or later installed\. To install it or upgrade, see [The `eksctl` command line utility](eksctl.md)\.
