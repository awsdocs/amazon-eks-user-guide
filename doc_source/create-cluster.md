...
+ The [IAM principal](https://docs.aws.amazon.com/IAM/latest/UserGuide/intro-structure.html) that created the cluster is the only principal that has access to the cluster\. [Grant permissions to other [IAM principals](https://docs.aws.amazon.com/IAM/latest/UserGuide/intro-structure.html)](grant-k8s-access.md) so they can access your cluster\.
