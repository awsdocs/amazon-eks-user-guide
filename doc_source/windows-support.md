...
This procedure only works for clusters that were created with `eksctl` and assumes that your `eksctl` version is `0.11.1` or later\. You can check your version with the following command\.
