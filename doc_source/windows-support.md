...
This procedure only works for clusters that were created with `eksctl` and assumes that your `eksctl` version is `0.17.0-rc.0` or later\. You can check your version with the following command\.
