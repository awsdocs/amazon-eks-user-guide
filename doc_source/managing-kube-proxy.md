...
For version compatiblity and skew policy, EKS adopts upstream kubernetes [kube-proxy version skew policy](https://kubernetes.io/releases/version-skew-policy/#kube-proxy). Accordingly, EKS at minor version N can support upto N-2 minor versions of kube-proxy addon.
