...
+ Verify that version 0\.188\.0 or later of the `eksctl` command line tool installed on your computer or AWS CloudShell\. For more information, see [Installation](https://eksctl.io/installation/) on the `eksctl` website\.
