...
+ AWS PrivateLink support isn't available in the Asia Pacific \(Osaka\), Asia Pacific \(Jakarta\), or Middle East \(UAE\) AWS Regions because the Amazon API Gateway service isn't available in these AWS Regions\.
