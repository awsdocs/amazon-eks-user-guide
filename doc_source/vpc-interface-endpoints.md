...
+ AWS PrivateLink support isn't available in the Asia Pacific \(Hyderabad\), Asia Pacific \(Jakarta\), Asia Pacific \(Melbourne\), Asia Pacific \(Osaka\), Europe \(Spain\), Europe \(Zurich\), Israel \(Tel Aviv\), or Middle East \(UAE\) AWS Regions\.
