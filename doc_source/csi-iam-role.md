...
1. On the **Add permissions** page, do the following:
   ...
   1. In the **Filter policies** box, enter `AmazonEBSCSIDriverServiceRolePolicy`\.

   1. Select the check box to the left of the `AmazonEBSCSIDriverServiceRolePolicy` returned in the search\.
