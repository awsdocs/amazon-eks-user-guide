...
+ The AWS CLI version 1\.18\.71 or later installed\. To install or upgrade the, see [Installing the AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-install.html)\. 
