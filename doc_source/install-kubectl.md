...
1. Download the Amazon EKS vended `kubectl` binary for your cluster's Kubernetes version from Amazon S3using the command for your hardware platform\.
   + **Kubernetes 1\.21**
     ...
     ```
     curl -o kubectl 1.21.2/2021-07-05/bin/linux/arm64/kubectl
     ```
   + **Kubernetes 1\.20**
     ...
     ```
     curl -o kubectl 1.20.4/2021-04-12/bin/linux/arm64/kubectl
     ```
   + **Kubernetes 1\.19**
     ...
     ```
     curl -o kubectl 1.19.6/2021-01-05/bin/linux/arm64/kubectl
     ```
   + **Kubernetes 1\.18**
     ...
     ```
     curl -o kubectl 1.18.9/2020-11-02/bin/linux/arm64/kubectl
     ```
   + **Kubernetes 1\.17**
     ...
     ```
     curl -o kubectl 1.17.12/2020-11-02/bin/linux/arm64/kubectl
     ```
...
1. \(Optional\) Verify the downloaded binary with the SHA\-256 sum for your binary\.
   ...
   1. Download the SHA\-256 sum for your cluster's Kubernetes version for Linuxusing the command for your hardware platform\.
      + **Kubernetes 1\.21**
        ...
        ```
        curl -o kubectl 1.21.2/2021-07-05/bin/linux/arm64/kubectl.sha256
        ```
      + **Kubernetes 1\.20**
        ...
        ```
        curl -o kubectl 1.20.4/2021-04-12/bin/linux/arm64/kubectl.sha256
        ```
      + **Kubernetes 1\.19**
        ...
        ```
        curl -o kubectl 1.19.6/2021-01-05/bin/linux/arm64/kubectl.sha256
        ```
      + **Kubernetes 1\.18**
        ...
        ```
        curl -o kubectl 1.18.9/2020-11-02/bin/linux/arm64/kubectl.sha256
        ```
      + **Kubernetes 1\.17**
        ...
        ```
        curl -o kubectl 1.17.12/2020-11-02/bin/linux/arm64/kubectl.sha256
        ```
