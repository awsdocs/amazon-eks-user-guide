...
**Note**  
You must use a `kubectl` version that is within one minor version difference of your Amazon EKS cluster control plane\. For example, a 1\.17 `kubectl` client should work with Kubernetes 1\.16, 1\.17 and 1\.18 clusters\.<a name="install-kubectl-macos"></a>
