...
## All Regions except China \(Ningxia\) and China \(Beijing\)<a name="install-kubectl-steps"></a>

To install `kubectl` if you're in a China Region, see [China Regions](#kubectl-china)\.<a name="install-kubectl-macos"></a>
...
## China Regions<a name="kubectl-china"></a>

Complete these instructions if you're in the China \(Beijing\) or China \(Ningxia\) Region\. To install `kubectl` if you're any any other Region, see [All Regions except China \(Ningxia\) and China \(Beijing\) ](#install-kubectl-steps)\.<a name="install-kubectl-macos-cn"></a>
...
1. After you install  `kubectl`  , you can verify its version with the following command:
   ...
   ```
   kubectl version --short --client
   ```<a name="install-kubectl-linux-cn"></a>
...
1. After you install  `kubectl`  , you can verify its version with the following command:
   ...
   ```
   kubectl version --short --client
   ```<a name="install-kubectl-windows-cn"></a>
