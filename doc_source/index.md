...
+ [Amazon EKS compute](eks-compute.md)
   ...
   + [Amazon EKS-optimized AMIs](eks-optimized-amis.md)
      + [Amazon EKS-optimized Amazon Linux 2 AMIs](eks-optimized-ami.md)
         ...
         + [Amazon EKS-optimized Amazon Linux 2 AMI versions](eks-linux-ami-versions.md)
         + [Retrieving Amazon EKS-optimized Amazon Linux 2 AMI IDs](retrieve-ami-id.md)
...
+ [Applications](eks-applications.md)
   + [Deploy a sample Linux application](sample-deployment.md)
...
+ [Security in Amazon EKS](security.md)
   + [Identity and access management for Amazon EKS](security-iam.md)
      ...
      + [Amazon EKS node IAM role](worker_node_IAM_role.md)
