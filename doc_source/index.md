...
+ [Getting started with Amazon EKS](getting-started.md)
   ...
   + [Installing or updating eksctl](eksctl.md)
...
+ [Amazon EKS networking](eks-networking.md)
   ...
   + [Amazon EKS networking add-ons](eks-networking-add-ons.md)
      + [Updating the Amazon VPC CNI plugin for Kubernetes add-on](managing-vpc-cni.md)
         ...
         + [Installing the Amazon VPC CNI plugin for Kubernetes metrics helper add-on](cni-metrics-helper.md)
...
+ [Observability in Amazon EKS](eks-observe.md)
   ...
   + [Amazon EKS add-on support for ADOT Operator](opentelemetry.md)
      ...
      + [Deploy the AWS Distro for OpenTelemetry Collector](deploy-collector.md)
         + [Deploy the AWS Distro for OpenTelemetry Collector using advanced configuration](deploy-collector-advanced-configuration.md)
...
+ [Amazon EKS Connector](eks-connector.md)
   ...
   + [Granting access to a user to view Kubernetes resources on a cluster](connector-grant-access.md)
