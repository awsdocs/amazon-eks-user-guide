...
+ [Workloads](eks-workloads.md)
   ...
   + [Amazon EKS add-ons](eks-add-ons.md)
      ...
      + [IAM roles for Amazon EKS add-ons](add-ons-iam.md)
         ...
         + [Use Pod Identitues to assign an IAM role to an Amazon EKS add-on](update-addon-role.md)
         + [Remove Pod Identiy associations from an Amazon EKS add-on](remove-addon-role.md)
