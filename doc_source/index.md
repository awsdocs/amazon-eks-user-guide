...
+ [Amazon EKS networking](eks-networking.md)
   ...
   + [Cluster VPC and subnet considerations](network_reqs.md)
...
+ [Observability in Amazon EKS](eks-observe.md)
   ...
   + [Amazon EKS add-on support for ADOT Operator](opentelemetry.md)
      ...
      + [Manage AWS Distro for OpenTelemetry Operator](adot-manage.md)
      + [Deploy the AWS Distro for OpenTelemetry Collector](deploy-collector.md)
         + [Deploy AWS Distro for OpenTelemetry Collector for Prometheus in Deployment mode](deploy-deployment.md)
         + [Deploy ADOT Collector for Amazon CloudWatch data](configure-cw.md)
         + [Deploy AWS Distro for OpenTelemetry (ADOT) Collector for X-Ray](configure-xray.md)
