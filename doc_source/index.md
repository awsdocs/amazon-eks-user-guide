...
+ [Manage compute resources by using nodes](eks-compute.md)
   + [Simplify node lifecycle with managed node groups](managed-node-groups.md)
      ...
      + [Update an Amazon EKS managed node group](update-managed-node-group.md)
      ...
      + [Delete an Amazon EKS managed node group](delete-managed-node-group.md)
   ...
   + [Simplify compute management with AWS Fargate](fargate.md)
      + [Get started with AWS Fargate using Amazon EKS](fargate-getting-started.md)
      + [Define which Pods use Fargate when launched](fargate-profile.md)
