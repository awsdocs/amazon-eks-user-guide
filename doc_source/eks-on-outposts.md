...
+  `IPv6` can't be used for service link or local network traffic on AWS Outposts\. You shouldn't create your Amazon EKS cluster with the `IPv6` IP family if you plan to run Amazon EKS worker nodes on AWS Outposts\. 
