...
+  IPv6 cannot be used for service link or local network traffic on AWS Outposts\. You should not create your Amazon EKS cluster with the IPv6 IP family if you plan to run Amazon EKS worker nodes on AWS Outposts\. 
