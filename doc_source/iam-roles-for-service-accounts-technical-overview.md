...
**Note**  
Your cluster doesn't need to use the mutating web hook to configure the environment variables and token file mounts; you can choose to configure pods to add these environment variables manually\.
